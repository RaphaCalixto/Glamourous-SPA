      ...
      >
        ...
        <div className="contact__data">
          <div className="contact__data__description">
            ...
            <p>
            Do you have any questions? Don't worry, we're here to help! 
            <p>
            Don't hesitate to get in touch with us, we'll be happy to assist you!
            </p>
            </p>
            <div>
              <p>
                <strong>Address:</strong> 22061‑030, Copacabana
              </p>
              <p>
                <strong>Email:</strong> glamourousSPA@gmail.com
              </p>
              <p>
                <strong>Website:</strong> www.glamourousSPA.com
              </p>
            </div>
          </div>
